...
if user_query:
    ...
    # Save user query in history (your custom function)
    msgs.add_user_message(user_query)  # adds user message
    ...
    # Save AI response in history (your custom function)
    msgs.add_ai_message(response_content)  # adds ai message
    ...
    def prettify_intermediate_steps(steps):
        ...
        for i, step in enumerate(steps):
            action, result = step
            # Directly access the attributes of the AgentAction object
            tool = action.tool
            tool_input = action.tool_input
            log = action.log

            # Extract the part of the log before "Action"
